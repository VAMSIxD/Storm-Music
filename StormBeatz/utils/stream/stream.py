...
import config
from StormBeatz import Carbon, YouTube, app
from StormBeatz.core.call import StormBeatz
from StormBeatz.misc import db
from StormBeatz.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from StormBeatz.utils.exceptions import AssistantErr
from StormBeatz.utils.inline.play import (stream_markup,
                                          telegram_markup)
from StormBeatz.utils.inline.playlist import close_markup
from StormBeatz.utils.pastebin import StormBeatzbin
from StormBeatz.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await StormBeatz.force_stop_stream(chat_id)
