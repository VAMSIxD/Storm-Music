...
from StormBeatz.misc import SUDO_USERS as SUDOERS
from StormBeatz.plugins.StormBeatz.database.limitsdb import add_to_approved_user, remove_approved_user, get_approved_users, is_approved
from StormBeatz.utils.decorators.language import language
...
async def userapprove(client, message: Message, _):
    if MONGO_DB_URI is None:
        return await message.reply_text(
            "**Due to bot's privacy issues, You can't manage sudo users when you're using StormBeatz's Database.\n\n Please fill your MONGO_DB_URI in your vars to use this feature**"
        )
