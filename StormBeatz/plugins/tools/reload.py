...
from StormBeatz.utils.database import get_authuser_names, get_cmode
from StormBeatz.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from StormBeatz.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await StormBeatz.stop_stream(message.chat.id)
    except:
        pass
