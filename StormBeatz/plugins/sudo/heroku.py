...
from StormBeatz.misc import HAPP, SUDOERS, XCB
from StormBeatz.utils.database import (get_active_chats,
                                       remove_active_chat,
...
async def update_(client, message, _):
    ...
    if len(_final_updates_) > 4096:
        url = await StormBeatzbin(updates)
